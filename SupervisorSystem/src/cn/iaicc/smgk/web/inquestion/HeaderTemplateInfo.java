...
public class HeaderTemplateInfo implements Serializable {
	...
	public HeaderTemplateInfo(String label, String fieldName,
			String fieldValue, int fieldType, int selectType, int isInput,
			List<HeaderSelectTemplateInfo> selectList) {
		super();
		this.label = label;
		this.fieldName = fieldName;
		this.fieldValue = fieldValue;
