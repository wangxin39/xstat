...
<title>调查问卷评分管理</title>
<script type="text/javascript">
function updatePanel(num)
	{
		//请求的地址
		var url = 'ajaxGrade.do';
		var pars = 'num='+num;
    ...
    function processResponse(response)
	{
		...
		html +='<tr><td class=\"ttitle\"><strong class=\"font12red\">编号</strong></td><td class=\"ttitle\"><strong class=\"font12red\">实际分数</strong></td><td class=\"ttitle\"><strong class=\"font12red\">期次</strong></td><td class=\"ttitle\"><strong class=\"font12red\">部分问题</strong></td><td class=\"ttitle\"><strong class=\"font12red\">选项提示</strong></td></tr>';
		for(i=0;i<length;i++){
			html += '<tr><td>'+o.pageList[i].statID+'</td>';
			html += '<td><a href="#" OnClick="javascript:showDetail(\''+o.pageList[i].statID+'\')">'+o.pageList[i].marks+'</a></td>';
			html += '<td>'+o.planList[i]+'</td>';	
			html += '<td>'+o.partQuestionList[i]+'</td>';	
			html += '<td>'+o.selectList[i]+'</td></tr>';
		}
		html += '</table>';
	...
	function showDetail(id) {
		window.open('detailGradeStore.do?statID='+id,'详细信息','width=500,height=400,scrollbars=yes,status=yes,left=100,top=100');		
	}
...
<body>
<div class="cright">
  <div class="title font16h">评分管理</div>
  <div class="container">	
	<div id="tablecontent">
	<table  width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#cccccc">
		<tr>
			...
			<td class="ttitle"><strong class="font12red">实际分数</strong></td>
			<td class="ttitle"><strong class="font12red">期次</strong></td>
			<td class="ttitle"><strong class="font12red">部分问题名称</strong></td>
			<td class="ttitle"><strong class="font12red">选项提示</strong></td>
		</tr>
		<s:iterator value="%{pageList}" status="stat">
			<tr>
				<td><s:property value="statID" /></td>
				<td><a href="#" OnClick="javascript:showDetail('<s:property value="statID"/>')"><s:property value="marks" /></a></td>
				<td><s:property value="planList[#stat.index]" /></td>
