...
<body>
<div class="cright">
  <div class="title font16h">主题模板详细信息</div>
  <div class="container">	
	<table border="0" align="left" cellspacing="3" cellpadding="2">
	<tr>
	<td align="left">模板编号:</td>
	<td align="left"><s:property value="%{#request.TEMPLATE.reportTemplateID}"/>&nbsp;</td>
	</tr>
	<tr>
	...
	<td align="left"><s:property value="%{#request.TEMPLATE.path}"/>&nbsp;</td>
	</tr>
	<tr>
	<td align="left">添加时间:</td>
	<td align="left"><s:date format="yyyy-MM-dd" name="%{#request.TEMPLATE.addTime}"/></td>
	</tr>
	<tr>
	<td align="left">状态:</td>
