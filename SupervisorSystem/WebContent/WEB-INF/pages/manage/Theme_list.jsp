...
<script type="text/javascript">
    ...
    function processResponse(response)
	{
		...
		html +='<tr><td class=\"ttitle\"><strong class=\"font12red\">主题编号</strong></td><td class=\"ttitle\"><strong class=\"font12red\">主题名称</strong></td><td class=\"ttitle\"><strong class=\"font12red\">描述</strong></td><td class=\"ttitle\"><strong class=\"font12red\">状态</strong></td><td class=\"ttitle\"><strong class=\"font12red\">操作</strong></td></tr>';
		for(i=0;i<length;i++){
			html += '<tr><td>'+o.pageList[i].themeID+'</td>';
			html += '<td>'+o.pageList[i].title+'</td>';	
			html += '<td>'+o.pageList[i].description+'</td>';
			html += '<td>'+o.statusList[i]+'</td>';
			html += '<td><input type="button" onClick="ConfirmButton(\'editThemeInput.do?themeID='+o.pageList[i].themeID+'\',\'是否确认修改主题信息!\');" value="修改">';
			html += '<input type="button" onClick="ConfirmButton(\'deleteThemeProcess.do?themeID='+o.pageList[i].themeID+'\',\'是否确认删除主题信息!\');" value="删除">';
			html += '</td></tr>';			
		}
		html += '</table>';
...
<body>
<div class="cright">
  <div class="title font16h">主题管理</div>
  <div class="container">	
	    <table width="100%" border="0" cellspacing="10">
	    	<tr>
	     	  <td align="right"><input type="button" name="button" value="增加新的主题" class="button" onclick="GoURL('addThemeInputs.do');"/>
	     	    &nbsp;&nbsp;&nbsp;&nbsp;</td>
	      </tr>
	    </table>
<div id="tablecontent">
	<table  width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#cccccc">
		<tr>
			<td class="ttitle"><strong class="font12red">主题编号</strong></td>
		...
		<s:iterator value="%{pageList}" status="stat">
			<tr>
				<td><s:property value="themeID" /></td>
				<td><s:property value="title" />&nbsp;</td>
				<td><s:property value="description" />&nbsp;</td>
				<td><s:property value="statusList[#stat.index]" />&nbsp;</td>
				<td>
					<input type="button" onClick="ConfirmButton('editThemeInput.do?themeID=<s:property value="%{themeID}"/>','是否确认修改主题信息!');"	value="修改">
					<input type="button" onClick="ConfirmButton('deleteThemeProcess.do?themeID=<s:property value="%{themeID}"/>','是否确认删除主题信息!');" value="删除">
				</td>
			</tr>
		</s:iterator>
	</table>
