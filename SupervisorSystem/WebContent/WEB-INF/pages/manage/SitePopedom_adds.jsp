...
<body>
<div class="cright">
  <div class="title font16h">更改网站权限信息</div>
  <div class="container">	
<SCRIPT type="text/javascript">
	document.getElementById("popedom").select();
</SCRIPT>

<s:form action="addSitePopedomProcess" name="addSPP">
	<table border="0">
		<tr>
			<td>可选择的权限</td>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td align="right"><s:select name="popedom" multiple="true"
				...
				list="%{#session.HADPOPLIST}" onselect="true"  >
			</s:select></td>
		</tr>
	</table>
	<tr>
		<td>&nbsp;</td>
		<td align="right"><input type="button" value="增加"
			onclick="submit()" />&nbsp; <input type="button" value="返回"
			onClick="BackPage()"> <script type="text/javascript">
function BackPage() {
	history.back();
}
</script></td>
