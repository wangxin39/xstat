...
<body>
<div class="cright">
  <div class="title font16h">添加评分标准关系</div>
  <div class="container">	
	<s:form action="addGradeStdRelationProcess" method="post">
	...
	<s:select label="权重" list="%{#session.GLOBALSELECTWEIGHTINFOLIST}" name="selectWeightID" listValue="weight" listKey="selectWeightID" headerKey="-1"></s:select>
	</s:if>
	<s:else>
