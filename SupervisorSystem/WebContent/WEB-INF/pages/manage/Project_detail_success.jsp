...
<body>
<div class="cright">
  <div class="title font16h">项目详细信息</div>
  <div class="container">	
	
	<table border="0" align="left" cellspacing="3" cellpadding="2">
	<tr>
	<td align="left">项目编号:</td>
	<td align="left"><s:property value="%{#request.PROJECTINFO.projectID}"/></td>
	</tr>
	<tr>
	<td align="left">项目名称:</td>
	<td align="left"><s:property value="%{#request.PROJECTINFO.name}"/></td>
	</tr>
	<tr>
	<td align="left">客户名称:</td>
	<td align="left"><s:property value="%{#request.COMPANYNAME}"/></td>
	</tr>
	<tr>
	<td align="left">项目描述:</td>
	<td align="left"><s:property value="%{#request.PROJECTINFO.description}"/></td>
	</tr>
	<tr>
	<td align="left">状态:</td>
