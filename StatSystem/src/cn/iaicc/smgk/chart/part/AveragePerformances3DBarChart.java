...
public class AveragePerformances3DBarChart extends org.jfree.ui.ApplicationFrame {
	...
	public AveragePerformances3DBarChart(String title) {
		...
		this.createTitle = title;
		 ...
		 try {
			 File dir = new File("charts/2008/q1/a1/");
				if (!dir.exists()) {
					dir.mkdir();
				}
				// 生成PNG图片
    ...
    protected CategoryDataset createDataset() {
        ...
        dataset.addValue(96.76, "2007 average score", "2007 average score");
        dataset.addValue(100, "2008 Q1", "2008 Q1");
        return dataset;
    }   
	...
	{
		AveragePerformances3DBarChart demo = new AveragePerformances3DBarChart("average performances in section A1");
		demo.pack();
