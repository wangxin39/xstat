...
public class SectionComparisons3DBarChart extends org.jfree.ui.ApplicationFrame {
    ...
    protected CategoryDataset createDataset() {
        ...
        dataset.addValue(50, "BeiJing I", "BeiJing I");
        ...
        dataset.addValue(0, "WenZhou", "WenZhou");
        dataset.addValue(91.67, "WuHan", "WuHan");                
        dataset.addValue(91.67, "Xi'An", "Xi'An");
        dataset.addValue(100, "XiaMen", "XiaMen");
        dataset.addValue(100, "NanJing", "NanJing");
        dataset.addValue(91.67, "KunMing", "KunMing");
        dataset.addValue(100, "Hong Kong", "Hong Kong");
        dataset.addValue(91.67, "Macau", "Macau");   
        dataset.addValue(89.47, "average", "average");           
        return dataset;
    }   
	...
	{
		SectionComparisons3DBarChart demo = new SectionComparisons3DBarChart("follow up");
		demo.pack();
