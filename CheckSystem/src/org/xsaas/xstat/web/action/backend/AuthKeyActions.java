package org.xsaas.xstat.web.action.backend;
...
public class AuthKeyActions extends ActionSupport {
	 /**
	 * 
	 */
	private static final long serialVersionUID = 8175144302542453719L;
	...
	private static final String CODE_LIST = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890";
	    ...
	    public AuthKeyActions(HttpServletResponse response) {
	    ...
	    public AuthKeyActions(HttpServletResponse response,int iNum,String codeList) {
	        this.response = response;
