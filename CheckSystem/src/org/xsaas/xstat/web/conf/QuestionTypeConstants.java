...
public class QuestionTypeConstants {
		...
		//SelectType选项信息文件类型 jasperreport_info
		public static LinkedHashMap<Integer,String> SelectTypeDict;
		...
		static{
			...
			//OptionValue选项值 question_select_info
			OptionValueDict.put(new Integer(NA),"NA");
			...
			//SelectType选项信息文件类型 jasperreport_info
			SelectTypeDict.put(new Integer(SDANXUAN),"单选");
			SelectTypeDict.put(new Integer(SDUOXUAN),"多选");
