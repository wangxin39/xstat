...
<body>
<div class="cright">
	<div class="title font16h">调查问卷</div>
    <div class="container">
<table border="0">
<tr>
<td>计划</td>
...
<input type="button" value="答卷" onclick="goPage('<s:property value="inquisitionList[#idx.index].inquisitionID"/>','<s:property value="planID"/>')">
</s:if>
</td>
</tr>
</s:iterator>
