...
public class AddRealityActions extends ActionSupport {
	/**
	 * 
	 */
	private static final long serialVersionUID = 453855886740013266L;
	private static Log logger = LogFactory.getLog(AddRealityActions.class);
	...
	public String execute() throws Exception {	
		try{
			...
			if(isOK != null && "OK".equals(isOK)) {
				RealityCheckInfo info = new RealityCheckInfo();
				...
				realityCheckInfoService.saveRealityCheckInfo(info);
