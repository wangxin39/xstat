...
<body>
<div class="cright">
  <div class="title font16h">草稿详细信息</div>
  <div class="container">	
	<table border="0" align="left" cellspacing="3" cellpadding="2">
	<tr>
	<td align="left">草稿箱编号:</td>
	<td align="left"><s:property value="%{#request.DRAFT.draftID}"/>&nbsp;</td>
	</tr>
	<tr>
	...
	<td align="left"><s:property value="%{#request.DRAFT.sendTo}"/>&nbsp;</td>
	</tr>
	<tr>
	<td align="left">附件:</td>
	<td align="left"><s:property value="%{#request.DRAFT.att}"/>&nbsp;</td>
	</tr>
	<tr>
	<td align="left">发送主题:</td>
	<td align="left"><s:property value="%{#request.DRAFT.topic}"/>&nbsp;</td>
	</tr>
	<tr>
	<td align="left">发送内容:</td>
	<td align="left"><s:property value="%{#request.DRAFT.content}"/>&nbsp;</td>
	</tr>
	<tr>
	...
	<td align="left"><s:date format="yyyy-MM-dd HH:mm:ss" name="%{#request.DRAFT.sendTime}"/>&nbsp;</td>
	</tr>
	<tr>
	<td align="left">状态:</td>
