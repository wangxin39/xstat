...
<body>
<div class="cright">
  <div class="title font16h">表头选项详细信息</div>
  <div class="container">	
	<table border="0" align="left" cellspacing="3" cellpadding="2">
	<tr>
	<td align="left">选项编号:</td>
	<td align="left"><s:property value="%{#request.ISELECTLIST.headerSelectID}"/>&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
	<td align="left">表头信息:</td>
	<td align="left"><s:property value="%{#request.HEADEREDIT}"/>&nbsp;</td>
	</tr>
	<tr>
	<td align="left">选择信息:</td>
	<td align="left"><s:property value="%{#request.SELECTLIST}"/>&nbsp;</td>
	</tr>
	<tr>
	<td align="left">显示顺序:</td>
	<td align="left"><s:property value="%{#request.ISELECTLIST.showOrder}"/>&nbsp;</td>
	</tr>
	<tr>
	<td align="left">字段名称:</td>
	<td align="left"><s:property value="%{#request.ISELECTLIST.fieldName}"/>&nbsp;</td>
	</tr>
	<tr>
	<td align="left">
