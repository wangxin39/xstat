...
<script type="text/javascript">
    ...
    function processResponse(response)
	{
		...
		for(i=0;i<length;i++){
			...
			if((o.pageList[i].questionType <= 4 || o.pageList[i].questionType >= 7) && (o.pageList[i].fatherPqID > 0 || o.pageList[i].fatherPqID == null)) {
			...
			if( (o.pageList[i].questionType <= 4 || o.pageList[i].questionType >= 7) && (o.pageList[i].selectType == 2 || o.pageList[i].selectType == null)){
...
<script type="text/javascript" src="<s:url value="/js/smgk/partquestion_add.js"/>"></script>
</head>
		...
		<s:iterator value="%{pageList}" status="stat">
			<tr>
				...
				<td>
					...
					<s:if test="(questionType <= 4 || questionType >= 7) && (fatherPqID == 0 || fatherPqID == null)">
					...
					<s:if test="(questionType <= 4 || questionType >= 7) && (selectType == 2 || selectType == null)">
