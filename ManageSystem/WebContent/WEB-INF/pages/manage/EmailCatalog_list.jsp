...
function updatePanel(num)
    ...
    function processResponse(response)
	{
		...
		html +='<tr><td class=\"ttitle\"><strong class=\"font12red\">分类编号</strong></td><td class=\"ttitle\"><strong class=\"font12red\">名称</strong></td><td class=\"ttitle\"><strong class=\"font12red\">国家</strong></td><td class=\"ttitle\"><strong class=\"font12red\">语言</strong></td><td class=\"ttitle\"><strong class=\"font12red\">操作</strong></td></tr>';
		for(i=0;i<length;i++){
			html += '<tr><td>'+o.pageList[i].acID+'</td>';
			html += '<td>'+o.pageList[i].name+'</td>';	
			html += '<td>'+o.pageList[i].country+'</td>';	
			html += '<td>'+o.pageList[i].lang+'&nbsp;</td>';
			html += '<td><input type="button" onClick="ConfirmButton(\'editEmailCatalogInput.do?acID='+o.pageList[i].acID+'\',\'是否确认修改分类信息!\');" value="修改"/>'; 
			html += '<input type="button" onClick="ConfirmButton(\'deleteEmailCatalogProcess.do?acID='+o.pageList[i].acID+'\',\'是否确认删除分类信息!\');" value="删除"/>';
...
<body>
<div class="cright">
  <div class="title font16h">分类信息管理</div>
  <div class="container">	
	    <table width="100%" border="0" cellspacing="10">
	    	<tr>
	     	  <td align="right"><input type="button" name="button" value="增加新分类信息" class="button" onclick="GoURL('addEmailCatalogInputs.do');"/>
	     	    &nbsp;&nbsp;&nbsp;&nbsp;</td>
	      </tr>
	    </table>
	<div id="tablecontent">
	<table  width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#cccccc">
		<tr>
			<td class="ttitle"><strong class="font12red">分类编号</strong></td>
			<td class="ttitle"><strong class="font12red">名称</strong></td>
			<td class="ttitle"><strong class="font12red">国家</strong></td>
			<td class="ttitle"><strong class="font12red">语言</strong></td>
			<td class="ttitle"><strong class="font12red">操作</strong></td>
		</tr>
		<s:iterator value="%{pageList}">
			<tr>
				<td><s:property value="acID" /></td>
				<td><s:property value="name" />&nbsp;</td>
				<td><s:property value="country" />&nbsp;</td>
				<td><s:property value="lang" />&nbsp;</td>
				<td>
					<input type="button" onClick="ConfirmButton('editEmailCatalogInput.do?acID=<s:property value="%{acID}"/>','是否确认修改分类信息!');" value="修改"> 
					<input type="button" onClick="ConfirmButton('deleteEmailCatalogProcess.do?acID=<s:property value="%{acID}"/>','是否确认删除分类信息!');" value="删除">
				</td>
			</tr>
		</s:iterator>
	</table>
